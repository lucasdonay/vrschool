...
class CustomTileCourses extends StatefulWidget {
  int id;
  String name;
  String subtitle;
  ...
  @override
  State<CustomTileCourses> createState() => _CustomTileCoursesState();
}

class _CustomTileCoursesState extends State<CustomTileCourses> {
  bool isDarkMode =
